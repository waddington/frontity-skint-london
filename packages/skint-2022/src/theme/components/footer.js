...
const FacebookIcon = () => (
    <a className={iconLinkClasses} href="https://www.facebook.com/SkintLondon" target="_blank">
...
const TwitterIcon = () => (
    <a className={iconLinkClasses} href="https://twitter.com/SkintLondon" target="_blank">
        <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`${iconSize}`}
             viewBox="0 0 24 24">
            <path
...
const InstagramIcon = () => (
    <a className={iconLinkClasses} href="https://www.instagram.com/skint_london/" target="_blank">
            ...
            <footer className="w-full bg-slate-300 border-solid border-skintRed border-0 border-t-8">
                <div className="max-w-screen-xl mx-auto px-8 py-12 flex flex-col items-center space-y-8 md:flex-row md:justify-between md:space-y-0 md:items-start">
                    <div className="max-w-md inline-flex flex-col space-y-5 items-center">
                        <img src="https://www.skintlondon.com/wp-content/uploads/2014/03/431x80px-Logo-01.png" />
